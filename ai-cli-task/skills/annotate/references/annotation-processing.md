...
This mitigates the risk of annotation content containing hidden instructions that could influence agy's behavior when subsequently reading the task file.
