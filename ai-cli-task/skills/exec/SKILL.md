...
- The executor should follow project coding conventions (check AGENTS.md, GEMINI.md, or CLAUDE.md if present)
...
- After successful execution of all steps, the user should run `/check --checkpoint post-exec`
