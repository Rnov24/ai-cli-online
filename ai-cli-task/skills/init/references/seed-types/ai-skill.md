...
- **Collection Direction**: Skill design patterns, Antigravity plugin & skill API, prompt engineering techniques
- **Key Sources**: Antigravity docs, skill-creator guidelines, MCP spec, prompt engineering papers
...
- **Key Sources**: Antigravity API testing, prompt evaluation tools, A/B testing frameworks
...
- **Key Sources**: Antigravity CLI skill guidelines, UX heuristics for conversational AI
...
- **Collection Direction**: Antigravity API reference, MCP protocol spec, prompt engineering patterns
