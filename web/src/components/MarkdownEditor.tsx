...
const SLASH_COMMANDS = [
  ...
  // Google Antigravity CLI (agy) built-in
  { cmd: '/goal', desc: 'Autonomous long-running execution until complete' },
  { cmd: '/plan', desc: 'Enter plan mode for step-by-step planning' },
  { cmd: '/grill-me', desc: 'Interactive interview to refine and align plans' },
  { cmd: '/browser', desc: 'Browser automation and web search' },
  { cmd: '/schedule', desc: 'Set a timer or recurring cron schedule' },
  { cmd: '/learn', desc: 'Save behavioral learning / persistent memory' },
  { cmd: '/teamwork-preview', desc: 'Autonomous multi-agent coordination' },
  { cmd: '/review', desc: 'Review code changes and diffs' },
  { cmd: '/model', desc: 'Select model for current session' },
  { cmd: '/agents', desc: 'List and switch available agents' },
  { cmd: '/plugins', desc: 'Manage Antigravity plugins' },
  { cmd: '/compress', desc: 'Compress conversation context' },
  { cmd: '/clear', desc: 'Clear conversation history' },
  { cmd: '/doctor', desc: 'Run diagnostics and health check' },
  { cmd: '/permissions', desc: 'Manage tool permissions' },
  { cmd: '/mcp', desc: 'MCP server management' },
  { cmd: '/help', desc: 'Get help for commands and options' },
  { cmd: '/exit', desc: 'Exit Antigravity CLI session' },
  // Antigravity Task Lifecycle (ai-cli-task plugin)
  { cmd: '/ai-cli-task', desc: 'Task lifecycle management (13 skills)' },
  { cmd: '/auto', desc: 'Autonomous full lifecycle loop' },
  { cmd: '/init', desc: 'Initialize task module + branch' },
  { cmd: '/research', desc: 'Collect external references' },
  { cmd: '/check', desc: 'Check feasibility (post-plan/mid/post-exec)' },
  { cmd: '/verify', desc: 'Run domain-adapted tests' },
  { cmd: '/exec', desc: 'Execute implementation plan' },
  { cmd: '/merge', desc: 'Merge task branch to main' },
  { cmd: '/report', desc: 'Generate completion report' },
  { cmd: '/cancel', desc: 'Cancel task + optional cleanup' },
  { cmd: '/list', desc: 'Query task status (read-only)' },
  { cmd: '/annotate', desc: 'Process Plan panel annotations' },
  { cmd: '/summarize', desc: 'Regenerate context summary' },
];
